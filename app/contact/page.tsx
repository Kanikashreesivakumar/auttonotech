...
import { submitContactForm } from '@/lib/supabaseFunction'

export default function ContactPage() {
  const handleSubmit = async (name: string, email: string, phone: string, message: string): Promise<void> => {
    try {
    ...
    <>
      ...
      <section className="relative py-20 bg-gray-dark">
        <div className="absolute inset-0 z-0 opacity-80">
          <Image src="/contact.jpeg?height=600&width=1920" alt="Contact Us" fill className="object-cover" />
        </div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Contact Us</h1>
            <p className="text-xl text-white/90">Get in touch with our team to discuss your outsourcing needs</p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="space-y-8 mt-8">
                  <div className="flex items-start transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-gray-dark mb-1">Email Us</h3>
                      ...
                      <p className="text-gray-600">
                        <a
                          href="mailto:support@auttonotech.com"
                          className="hover:text-primary transition-colors duration-200"
                        >
                          support@auttonotech.com
                        </a>
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-12">
                  <h3 className="text-lg font-bold text-gray-dark mb-4">Follow Us</h3>
                  <div className="flex space-x-4">
                    <a
                      href="#"
                      className="bg-primary/10 p-3 rounded-full hover:bg-primary/20 transition-all duration-300 hover:-translate-y-1"
                      aria-label="Facebook"
                    >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal>
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Stay updated with the latest news, industry insights, and innovations from Auttonotech.
            </p>
            <div className="max-w-md mx-auto">
              <form className="flex flex-col sm:flex-row gap-4">
                ...
                <button
                  type="submit"
                  className="bg-white text-primary px-6 py-3 rounded-md hover:bg-gray-100 transition-all duration-300 hover:shadow-lg"
                >
                  Subscribe
                </button>
              </form>
