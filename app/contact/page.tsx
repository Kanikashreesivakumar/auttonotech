    ...
    <>
      ...
      <section className="relative py-20 bg-gray-900">
        <div className="absolute inset-0 z-0 opacity-30">
          <Image src="/placeholder.svg?height=600&width=1920" alt="Contact Us" fill className="object-cover" />
        </div>

        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">Contact Us</h1>
            <p className="text-xl text-white/90">Get in touch with our team to discuss your project</p>
          </div>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="space-y-8 mt-8">
                  <div className="flex items-start transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-secondary mb-1">Email Us</h3>
                  ...
                  <div className="flex items-start transition-all duration-300 hover:translate-x-2">
                    ...
                    <div>
                      <h3 className="text-lg font-bold text-secondary mb-1">Call Us</h3>
                      <p className="text-gray-600">
