    ...
    <>
      ...
      <section className="relative py-20 bg-gray-dark">
        <div className="absolute inset-0 z-0 opacity-60">
          <Image
            src="/about.jpeg?height=600&width=1920"
        ...
        >
          <div className="max-w-3xl">
            ...
            >
              Your trusted partner in BPO, KPO, and HRO services since 2020. We
              help businesses streamline operations, reduce costs, and achieve
              their goals through innovative outsourcing solutions.
            </motion.p>
          </div>
        </motion.div>
      </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <SectionHeading
                  title="Our Company"
                  subtitle="A legacy of excellence in outsourcing services"
                />
                ...
                <motion.p
                  ...
                  className="text-gray-600 mb-6"
                >
                  With a global presence and a team of skilled professionals, we
                  serve clients worldwide, bringing together the best talent and
                ...
                >
                  Our multidisciplinary team includes experienced professionals
                  across various domains who work collaboratively to deliver
                  integrated solutions that meet the unique needs of each client
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              >
                ...
                <p className="text-gray-600">
                  To be the global leader in innovative outsourcing solutions
                  that transform businesses and improve operational efficiency.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600">
                  To deliver exceptional value to our clients through innovative
                  BPO, KPO, and HRO solutions that address their most complex
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="relative h-96 rounded-lg overflow-hidden shadow-xl">
                ...
                >
                  <Image
                    src="/design.png?height=600&width=800"
                    alt="Our Approach"
                    fill
                    className="object-cover"
                  />
        ...
        <section className="py-20">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-8">
              At Auttonotech, we offer a dynamic and collaborative work
              environment where you can grow your career while working on
